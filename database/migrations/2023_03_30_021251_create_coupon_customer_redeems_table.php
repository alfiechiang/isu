...
return new class extends Migration
{
    ...
    {
        Schema::create('coupon_customer_redeems', function (Blueprint $table) {
            $table->comment("顧客使用優惠券紀錄");
            ...
            $table->uuid('coupon_customer_id')->nullable()->comment("顧客優惠券ID");
        });
    }
    ...
    {
        Schema::dropIfExists('coupon_customer_redeems');
    }
};
