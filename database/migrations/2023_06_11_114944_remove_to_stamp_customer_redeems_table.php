...
return new class extends Migration
{
    ...
    {
        Schema::table('stamp_customer_redeems', function (Blueprint $table) {
    ...
    public function down(): void
    {
        Schema::create('stamp_customer_redeems', function (Blueprint $table) {
            ...
            $table->uuid('stamp_customer_id')->nullable()->comment("顧客集章ID");
            $table->foreign('stamp_customer_id')->references('id')->on('stamp_customers')->onDelete('cascade');
        });
    }
};
